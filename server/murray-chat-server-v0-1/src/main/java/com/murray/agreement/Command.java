...
public interface Command {
    ...
    Byte
            ...
            AVATAR_REQUEST = 21, AVATAR = 22,//头像请求下载和发送
            GROUP_BASIC_REQUEST = 23, GROUP_BASIC_RESPONSE = 24,//群组基本信息请求下载和发送
            ...
            DEPARTMENT_REQUEST = 29, DEPARTMENT_RESPONSE = 30,//部门信息请求和响应
            ...
            GROUP_MSG_HAVE_READ_CHAT_RESPONSE = 35,//群聊@的用户未读情况反馈
