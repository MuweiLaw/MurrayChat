 ...
 */
public class MeetingReminderRequest extends Packet {
    /**
     * 会议提醒编号
     */
    ...
    public Byte getCommand() {
        return Command.MEETING_REMIND_REQUEST;
    }

    public MeetingReminderRequest() {
        this.meetingRemindNo = UUID.randomUUID().toString();
    }

    public MeetingReminderRequest(String title, String creator, Date startTime, String desc, String location, List<String> userList) {
        this.meetingRemindNo = UUID.randomUUID().toString();
        this.title = title;
