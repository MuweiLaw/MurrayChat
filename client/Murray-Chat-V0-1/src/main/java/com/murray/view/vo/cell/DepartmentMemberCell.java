 ...
 */
public class DepartmentMemberCell extends JLabel {

    public DepartmentMemberCell(ChatUserInfoResponse response) {
        super();
        //设置头像框
        JLabel avatarFrameLabel = new JLabel(ClientCache.AVATAR_FRAME_WHITE);
        avatarFrameLabel.setBounds(20, 15, 50, 50);
